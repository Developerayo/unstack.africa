                    ...
                    <ul className="block-tab">
                      <li className="active ">
                        ...
                        <div className="block-detail">
                          ...
                          <span className="topic">Open Source Pillars & Tales <h6 style={{color: "#E49205", fontWeight:"bold"}}>Keynote</h6></span>
                            <span className="speaker">
                              {" "}
                              <strong style={{ color: "grey" }}>
                                Speaker
                        ...
                        <div className="block-detail">
                          ...
                          <span className="topic">A Changing Landscape<h6 style={{color: "#E49205", fontWeight:"bold"}}>Keynote</h6></span>
                            <span className="speaker">
                              {" "}
                              <strong style={{ color: "grey" }}>
                                Speaker
                      ...
                      <li>
                        ...
                        <div className="block-detail">
                          <span className="time">10:15 - 10:35</span>
                          <span className="topic">Mystery Topic<h6 style={{color: "#E49205", fontWeight:"bold"}}>Keynote</h6></span>
                            <span className="speaker">
                              {" "}
                              <strong style={{ color: "grey" }}>
                                Speaker
